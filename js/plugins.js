	...
	jQuery.mbYTPlayer = {
		...
		getDataFromAPI: function( YTPlayer ) {
			...
			if( YTPlayer.videoData ) {
				...
				if( YTPlayer.isPlayer && !YTPlayer.opt.autoPlay ) {
					var bgndURL = jQuery.mbYTPlayer.locationProtocol + "//i.ytimg.com/vi/" + YTPlayer.videoID + "/hqdefault.png?raw=true?raw=true";
